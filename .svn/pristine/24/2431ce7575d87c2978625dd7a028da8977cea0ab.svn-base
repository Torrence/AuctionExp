 ...
 * 
 * @see nju.edu.auctionExp.model.user.User
 * @author MyEclipse Persistence Tools
 */

public class UserDAO extends CommonDAOImpl<User> implements ICommonDAO<User> {
	...
	public User findById(java.lang.String id) {
		...
		try {
			User instance = (User) getSession().get(
					"nju.edu.auctionExp.model.user.User", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(User instance) {
		...
		try {
			List results = getSession()
					.createCriteria("nju.edu.auctionExp.model.user.User")
